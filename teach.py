...
exp_name = 'teacher0_{}_seed{}'.format(args.arch, args.seed)
exp_path = './experiments0/{}'.format(exp_name)
...
class DatasetGenerator():
    ...
    def loadData(self):
        ...
        train_dataset = cifar100Nosiy(root='./data',
                                      train=True,
        ...
        data_loaders['test_dataset'] = DataLoader(dataset=test_dataset,
                                                  ...
                                                  pin_memory=True,
                                                  num_workers=self.num_of_workers)
        a= data_loaders['train_dataset']
        b= data_loaders['test_dataset'] 

        print("Num of train %d" % (len(train_dataset)))
        print("Num of test %d" % (len(test_dataset)))

        return a,b#data_loaders


train_loader, val_loader=DatasetGenerator.loadData(datasets.CIFAR100)
'''
...
trainset = cifar100Nosiy('./data', train=True, transform=transform_train, download=True, asym=False, seed =123, nosiy_rate=0.0)
